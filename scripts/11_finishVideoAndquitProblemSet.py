...
print("11. 完成学习模块或练习模块 completeLearning completeMaster:")

pipeLine = [
    {"$match": {"eventKey": {"$in": ["completeLearning", "completeMaster"]}, "eventTime": {"$gte": START_DATE, "$lt": END_DATE}, "platform": "app", "platform2": "iOS"}},
